...
El término **informática** viende del acrónimo de procesamiento de la INFORmación de forma autoMÁTICA.
...
Debemos tener claros entonces los conceptos de datos e intrucciones:
...
- **Dispositivos Perifericos**: transferencia de información con el exterior (ENTRADA - SALIDA).
...
La BIOS integra un software que se carga al enceder el ordenador y chequea que todo esté correcto antes de cargar el sistema operativo. El alto acoplamiento entre el software y el hardware de la BIOS establece el concepto de **[firmware](https://es.wikipedia.org/wiki/Firmware)**.
...
Sigue estando cercano al hardware, pero, en lugar de unos y y ceros, se programa usando mnemotécnicos, que son instrucciones más inteligibles por el programador que permiten comprender de una forma más sencilla qué hace el programa.
Este lenguaje necesita compilarse y traducirse al lenguaje máquina para poder ejeSe trabaja con los registros del procesador y direcciones físicas. En lenguajes de nivel más alto, ya se utilizan variables y estructuras más sofisticadas.
...
Podemos definir las carácterísticas de los lenguajes de una maera más educada si los agrupamos según  la forma en la que son ejecutados: 
...
Aqui podemos ver el grado de uso de los diversos lenguajes de programación según TIOBE:
...
podrían ser detectados durante el desarrollo, o bién en el futuro durante su
utilización.
...
Siendo más específicos, el Ciclo de Vida de Desarrollo de Software consta de unas serie de fases que varían según el modelo pero que podemos ver en el siguiene esquema:
...
1) Cuando la ejecución del programa se realizará un gran número de veces,es decir, cuando el programa permite automatizar el desarrollo detareas, complejas o no, de carácter repetitivo, como es el caso de una cadenade montaje, la confección de nóminas de los trabajadores, etc.
...
#### 5. Pruebas (testing)
En esta fase, se realizarán pruebas para garantizar que la aplicación se ha programado de acuerdo con las especificaciones originales y los distintos programas de los que consta la aplicción están perfectamente integrados y preparados para la explotación. Generalmente hay dos tipos de pruebas: 
...
En cualquier aplicación, como mínimo, deberán generarse los siguientes documentos: a)
Manual de usuario. Es, como ya se ha comentado anteriormente, el manual que utilizará el usuario para desenvolverse con el programa. Deberá ser autoexplicativo y de ayuda
...
![9bbba306ed3de516cd90200e32123dcc.png](_resources/9bbba306ed3de516cd90200e32123dcc.png)
...
Algunas característcas del código fuente son:
...
Los errores mas comunes en los que se suele incurrir en el desarrollo de sfotware son:
